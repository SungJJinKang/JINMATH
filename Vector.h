...
namespace Math
{
	...
	constexpr Vector<1, T> operator+(const Vector<1, T>& lhs, const Vector<RightComponentSize, T>& rhs)
	{
	...
	constexpr Vector<2, T> operator+(const Vector<2, T>& lhs, const Vector<RightComponentSize, T>& rhs)
	{
	...
	constexpr Vector<3, T> operator+(const Vector<3, T>& lhs, const Vector<RightComponentSize, T>& rhs)
	{
	...
	constexpr Vector<4, T> operator+(const Vector<4, T>& lhs, const Vector<4, T>& rhs)
	{
	...
	constexpr Vector<1, Y> operator+(X scalar, const Vector<1, Y>& rhs)
	{
	...
	template <typename X, typename Y, typename std::enable_if_t<std::is_arithmetic_v<X>, bool> = true>
	constexpr Vector<2, Y> operator+(X scalar, const Vector<2, Y>& rhs)
	{
	...
	template <typename X, typename Y, typename std::enable_if_t<std::is_arithmetic_v<X>, bool> = true>
	constexpr Vector<3, Y> operator+(X scalar, const Vector<3, Y>& rhs)
	{
	...
	template <typename X, typename Y, typename std::enable_if_t<std::is_arithmetic_v<X>, bool> = true>
	constexpr Vector<4, Y> operator+(X scalar, const Vector<4, Y>& rhs)
	{
