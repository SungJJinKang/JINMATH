...
#ifdef _Source_Core_Math_LightMath_Cpp_Quaternion_Scalar_reflection_h

#error "_Source_Core_Math_LightMath_Cpp_Quaternion_Scalar_reflection_h already included, missing '#pragma once' in _Source_Core_Math_LightMath_Cpp_Quaternion_Scalar_reflection_h"

#endif

#define _Source_Core_Math_LightMath_Cpp_Quaternion_Scalar_reflection_h
