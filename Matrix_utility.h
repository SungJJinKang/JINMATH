...
#		endif
	...
	template<typename T>
	inline math::Matrix<4, 4, T> perspectiveFovRH_ZO(T fov, T width, T height, T zNear, T zFar)
	{
	...
	template<typename T>
	inline math::Matrix<4, 4, T> perspectiveFovRH_NO(T fov, T width, T height, T zNear, T zFar)
	{
		assert(width > static_cast<T>(0));
		assert(height > static_cast<T>(0));
		assert(fov > static_cast<T>(0));
	...
	template<typename T>
	inline math::Matrix<4, 4, T> perspectiveFovLH_ZO(T fov, T width, T height, T zNear, T zFar)
	{
		assert(width > static_cast<T>(0));
		assert(height > static_cast<T>(0));
		assert(fov > static_cast<T>(0));
	...
	template<typename T>
	inline math::Matrix<4, 4, T> perspectiveFovLH_NO(T fov, T width, T height, T zNear, T zFar)
	{
		assert(width > static_cast<T>(0));
		assert(height > static_cast<T>(0));
		assert(fov > static_cast<T>(0));
	...
	template<typename T>
	inline math::Matrix<4, 4, T> perspectiveFov(T fov, T width, T height, T zNear, T zFar)
	{
#		if CURRENT_SETTING == LEFT_HAND_ZERO_TO_ONE
